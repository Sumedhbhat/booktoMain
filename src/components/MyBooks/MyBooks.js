            ...
            {book ? (
              <div className='container-fluid purchaseBookContainer'>
                <div className='row purchaseBookRow z-depth-3'>
                  <h5 className='center-align white-text myBooksHeader'>
                    Published Books
                  </h5>
                  {book.map((l, key) => (
                    <div className='col l3 offset-l3 m6 s12' key={key}>
                      <div className='card dashboardCard z-depth-3'>
                        <div className='card-image waves-effect waves-block waves-light'>
                          <img
                            className='activator dashboardCardImage'
                            src={l.thumbnail}
                            alt='msd'
                          />
                        </div>
                        ...
                        <div className='card-reveal cardRevealBox'>
                          ...
                          <h6 className='revealDescription revealTitle'>
                            <span className='bookInfo'>Book name</span>:<br />{" "}
                            {l.bookName}
                          </h6>
                          <h6 className='revealDescription revealTitle'>
                          ...
                          <h6 className='revealDescription revealTitle'>
                            <span className='bookInfo'>Book author</span>:<br />{" "}
                            {l.authorName}
                          </h6>
                          <h6 className='revealDescription revealTitle'>
                            <span className='bookInfo'>Book price</span>:<br />{" "}
                            <FaEthereum /> {l.price}
                          </h6>
                        </div>
                      </div>
